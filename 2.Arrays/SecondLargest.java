public class SecondLargest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Second Largest number in array is: " + getSecondLargest(numbers));
        System.out.println("Second Largest number in array is: " + getSecondLargest(numbers2));
        System.out.println("Second Largest number in array is: " + getSecondLargest(numbers3));
    }
}
